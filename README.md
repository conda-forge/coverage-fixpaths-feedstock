...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9589&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/coverage-fixpaths-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `coverage-fixpaths` can be installed with:

```
conda install coverage-fixpaths
```

It is possible to list all of the versions of `coverage-fixpaths` available on your platform with:
